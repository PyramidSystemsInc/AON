...
resource "azurerm_linux_web_app" "app" {
  ...
  app_settings = {
    "DEBUG"                  = false
    "OTEL_SERVICE_NAME"      = "aon${each.key}"
    # OTEL_RESOURCE_ATTRIBUTES = "service.instance.id=aon${each.key}"
    ...
    "AZURE_SEARCH_TITLE_COLUMN"                       = "global professional services firm"
